...
() {
  ...
  typeset -g POWERLEVEL9K_NETSPEED_ICON='⇄'
  typeset -g POWERLEVEL9K_NETSPEED_VISUAL_IDENTIFIER_EXPANSION='⇄'
  function prompt_netspeed() {
    # typeset -g POWERLEVEL9K_NETSPEED_CONTENT_EXPANSION='${P9K_IP_RX_RATE:+ %70F⇣$P9K_IP_RX_RATE}${P9K_IP_TX_RATE:+ %215F⇡$P9K_IP_TX_RATE}'
